    ...
    <div className="container mx-auto pt-15 pb-15 z-100" id="about-me">
      <div className="flex flex-col gap-y-20 ">
        <section className="ml-5 flex flex-col gap-y-5 md:w-3/4 max-sm:pr-2">
          ...
          <h2 className="text-black/44 dark:text-white/44 text-lg m-0">Front-End Developer</h2>

          <p className="md:text-lg sm:text-sm mt-5" style={{ lineHeight: "2" }}>
            Hi, I’m{" "}
          ...
          <p className="md:text-lg sm:text-sm mt-5" style={{ lineHeight: "2" }}>
            ...
            working toward refining my skills to achieve greater professionalism
            in this field
          </p>
          <p className="md:text-lg sm:text-sm mt-5" style={{ lineHeight: "2" }}>
